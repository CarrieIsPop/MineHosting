export default function Navbar({ setVista }) {
  return (
    <header className="bg-gray-800 p-3 md:p-5 shadow-lg flex justify-between items-center border-b border-gray-700">
      <h1 
        onClick={() => setVista('inicio')} 
        className="text-lg md:text-2xl font-bold text-green-500 tracking-wider cursor-pointer shrink-0"
      >
        ⛏️ MineHosting
      </h1>
      <nav>
        <ul className="flex gap-3 md:gap-6 font-semibold text-white text-sm md:text-base">
